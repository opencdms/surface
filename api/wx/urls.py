...
urlpatterns = [
    ...
    path('wx/reports/pgia/', views.PGIAReportView.as_view(), name='pgia-report'),
    ...
    path('wx/data/capture/monthly/', views.MonthlyFormView, name='monthly-form'),
    ...
    path('wx/product/daily_means/', views.DailyMeansView.as_view(), name='daily-means'),
