...
urlpatterns = [
    ...
    path('wx/maintenance_reports/get_available_profile_equipments/<int:maintenance_report_id>/<int:equipment_type_id>/', login_required(views.get_maintenance_report_view), name='view-maintenance-report'),
]
