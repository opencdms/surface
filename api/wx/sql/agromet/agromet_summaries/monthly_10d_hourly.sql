WITH filtered_data AS (
    SELECT
        ...
        END as value
        ,CASE
            WHEN EXTRACT(DAY FROM datetime AT TIME ZONE 'America/Belize') BETWEEN 1 AND 10 THEN 'agg_1'
            WHEN EXTRACT(DAY FROM datetime AT TIME ZONE 'America/Belize') BETWEEN 11 AND 20 THEN 'agg_2'
            WHEN EXTRACT(DAY FROM datetime AT TIME ZONE 'America/Belize') >= 21  THEN 'agg_3'
        END AS agg
